    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSignin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog.show();
                auth.signInWithEmailAndPassword(binding.EtemailIn.getText().toString(),binding.EtpassIn.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    @Override
        ...
        binding.tClickSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
